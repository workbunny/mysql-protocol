...
enum Errors : int
{
    ...
    case ERR_FINISH_CONNECT = 3003;
    case ERR_REGISTER = 3004;
    case ERR_READ = 3005;
    case ERR_PUT_WRITE_QUEUE = 3006;
    case ERR_WRITE_BY_EVENT = 3007;
    case ERR_WRITE_BY_QUEUE = 3008;
    case ERR_HANDLE_DATA = 3009;
    case ERR_EXCEPTION_CAUGHT = 3010;
    case ERR_SINGLE_EXECUTE_NODES = 3011;
    case NO_TRANSACTION_IN_MULTI_NODES = 3012;
    ...
    case ER_ERROR_DURING_CHECKPO = 1183;
    ...
    case ER_PARTITION_REQUIRES_VALUES_ERROR = 1454;
    case ER_PARTITION_WRONG_VALUES_ERROR = 1455;
    case ER_PARTITION_MAXVALUE_ERROR = 1456;
    case ER_PARTITION_SUBPARTITION_ERROR = 1457;
    case ER_PARTITION_WRONG_NO_PART_ERROR = 1458;
    case ER_PARTITION_WRONG_NO_SUBPART_ERROR = 1459;
    case ER_CASE_EXPR_IN_PARTITION_FUNC_ERROR = 1460;
    case ER_NO_CASE_EXPR_IN_RANGE_OR_LIST_ERROR = 1461;
    case ER_FIELD_NOT_FOUND_PART_ERROR = 1462;
    case ER_LIST_OF_FIELDS_ONLY_IN_HASH_ERROR = 1463;
    case ER_INCONSISTENT_PARTITION_INFO_ERROR = 1464;
    case ER_PARTITION_FUNC_NOT_ALLOWED_ERROR = 1465;
    case ER_PARTITIONS_MUST_BE_DEFINED_ERROR = 1466;
    case ER_RANGE_NOT_INCREASING_ERROR = 1467;
    case ER_INCONSISTENT_TYPE_OF_FUNCTIONS_ERROR = 1468;
    case ER_MULTIPLE_DEF_case_IN_LIST_PART_ERROR = 1469;
    case ER_PARTITION_ENTRY_ERROR = 1470;
    case ER_MIX_HANDLER_ERROR = 1471;
    case ER_PARTITION_NOT_DEFINED_ERROR = 1472;
    case ER_TOO_MANY_PARTITIONS_ERROR = 1473;
    case ER_SUBPARTITION_ERROR = 1474;
    case ER_CANT_CREATE_HANDLER_FILE = 1475;
    case ER_BLOB_FIELD_IN_PART_FUNC_ERROR = 1476;
    case ER_CHAR_SET_IN_PART_FIELD_ERROR = 1477;
    case ER_UNIQUE_KEY_NEED_ALL_FIELDS_IN_PF = 1478;
    case ER_NO_PARTS_ERROR = 1479;
    case ER_PARTITION_MGMT_ON_NONPARTITIONED = 1480;
    case ER_DROP_PARTITION_NON_EXISTENT = 1481;
    case ER_DROP_LAST_PARTITION = 1482;
    case ER_COALESCE_ONLY_ON_HASH_PARTITION = 1483;
    case ER_ONLY_ON_RANGE_LIST_PARTITION = 1484;
    case ER_ADD_PARTITION_SUBPART_ERROR = 1485;
    case ER_ADD_PARTITION_NO_NEW_PARTITION = 1486;
    case ER_COALESCE_PARTITION_NO_PARTITION = 1487;
    case ER_REORG_PARTITION_NOT_EXIST = 1488;
    case ER_SAME_NAME_PARTITION = 1489;
    case ER_CONSECUTIVE_REORG_PARTITIONS = 1490;
    case ER_REORG_OUTSIDE_RANGE = 1491;
    case ER_DROP_PARTITION_FAILURE = 1492;
    case ER_DROP_PARTITION_WHEN_FK_DEFINED = 1493;
    case ER_PLUGIN_IS_NOT_LOADED = 1494;
    case ER_MULTI_QUERY_TIMEOUT = 1495;
    case ER_MULTI_EXEC_ERROR = 1496;
    case ER_HAS_GONE_AWAY = 2006;
}
