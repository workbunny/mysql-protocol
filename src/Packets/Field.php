...
class Field implements PacketInterface
{
        ...
        try {
            return Packet::parser(function (Binary $binary) {
                ...
                if ($fixedLength !== self::PACKET_FIXED_LENGTH) {
                    throw new PacketException("Error: Invalid packet fixed length '$fixedLength', expected 0x0c");
                }
            ...
            throw new PacketException("Error: Failed to unpack field packet [{$e->getMessage()}]", $e->getCode(), $e);
        }
    }
    ...
    public static function pack(array $data): Binary
    {
        try {
            ...
            throw new PacketException("Error: Failed to pack field packet [{$e->getMessage()}]", $e->getCode(), $e);
        }
    }
}
