...
/**
 * COM_STMT_RESET — 重置预处理语句
 */
class StmtReset implements PacketInterface
{
    public const COMMAND = 0x1A;
    ...
    public static function unpack(Binary $binary): array
    {
        return Packet::parser(function (Binary $binary) {
            ...
            if ($command !== self::COMMAND) {
                throw new PacketException("Invalid command '$command', expected 0x1A", ExceptionCode::ERROR_VALUE);
            }
